...
namespace TestModel.ModelTests
{
    ...
    public class UnitTestGameModelGamePlayer
    {
        ...
        {
            GamePlayer gamePlayer = new GamePlayer("q", Color.Red, new CardDeck(), 0, 0);
        ...
        public void TestCompare_Compare_True()
        {
            ...
            GamePlayer gamePlayer1 = new GamePlayer("q", Color.Red, new CardDeck(), 0, 0);
            GamePlayer gamePlayer2 = new GamePlayer("q", Color.Red, new CardDeck(), 0, 0);
            GamePlayer gamePlayer3 = new GamePlayer("w", Color.Red, new CardDeck(), 0, 0);
            GamePlayer gamePlayer4 = new GamePlayer("q", Color.Green, new CardDeck(), 0, 0);
            GamePlayer gamePlayer5 = new GamePlayer("q", Color.Green, 
                new CardDeck(new List<Card>(){ new Card(TreasureAndStartPointsType.treasureOnMovingCell1)}), 0, 0);
            GamePlayer gamePlayer6 = new GamePlayer("q", Color.Red, new CardDeck(), 1, 0);
